...
public class Bank{
    ...
    //------------------------------------------------------
    public ArrayList<CreditCard> addCardToBank(CreditCard card,boolean confirmKey){ //recebe um boolean como chave de confirmaca Sim(true) e Nao(false)
    ...
    //------------------------------------------------------
    public ArrayList<Account> addAccountToBank(Account account,boolean confirmKey){ //recebe um boolean como chave de confirmaca Sim(true) e Nao(false)
    ...
    //------------------------------------------------------
    public ArrayList<Client> addClientToBank(Client client,boolean confirmKey){ //recebe um boolean como chave de confirmaca Sim(true) e Nao(false)
