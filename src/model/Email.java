...
public class Email{
    ...
    public void validateEmail(String p_email){
        ...
        if(p_email.length() > 78){ //total de 78 caracteres, 64 caracteres para a parte local e 14 para o dominio
            throw new InvalidEmailException("Erro: o email e invalido!\n");
        }

        if(!p_email.contains("@") || !p_email.contains(".")){ //verifica se o email esta completo contendo os caracteres da parte do dominio(ex:@gmail.com)
            throw new InvalidEmailException("Erro: o email e invalido!\n");
        }
