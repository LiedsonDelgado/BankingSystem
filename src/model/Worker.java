...
public class Worker extends Employee{
    ...
    public Worker(String p_name,String p_email,String p_phoneNumber,String p_salary,ExperienceLevel p_experienceLevel,Bank p_bank){
    ...
    public String showWorkerInfo(Worker worker){
        ...
        string.append("-Banco associado: " +worker.getEmployeeBank().getBankName() +"\n");
