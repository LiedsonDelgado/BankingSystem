...
public class StaffMember extends Employee{
    ...
    public StaffMember(String p_name,String p_email,String p_phoneNumber,String p_salary,ExperienceLevel p_experienceLevel,Bank p_bank){
        super(p_name,p_email,p_phoneNumber,p_salary,p_experienceLevel,p_bank);
    ...
    public String showStaffMemberInfo(StaffMember staffMember){
        ...
        string.append("-Banco associado: " +staffMember.getEmployeeBank().getBankName() +"\n");
