...
public class Bank{
    ...
    protected ArrayList<Object>instutionEmployees;
    ...
    public Bank(String p_name,String p_bankAdress,int p_code){
        ...
        this.instutionEmployees = new ArrayList<>();
    }
    ...
    public int getNumberOfEmployessFromBank(){
        return instutionEmployees.size();
    }
    //-----------------------------------------
    ...
    public void addEmployeeToBank(Object p_employee,boolean confirmKey){
        ...
        if(confirmKey){
            instutionEmployees.add(p_employee);
    ...
    public Object removeEmployeeFromBank(Object p_employee,boolean confirmKey){
        ...
        if(confirmKey){
            instutionEmployees.remove(p_employee);
    ...
    public String ShowBankInfo(){
        ...
        string.append("-Data de briacao: " +getCreationDate() +"\n");
    ...
    public void showEspecifiedEmployee(){
        ...
        do{
            ...
            System.out.println("2-Funcionario"); //Worker
            System.out.println("3-Membro de equipe"); //StaffMember
            System.out.println("4-Funcionario"); //Worker
            ...
            switch(opc){
                ...
                case 1:
                    for(Object employee : instutionEmployees){
                ...
                case 3:
                    for(Object employee : instutionEmployees){
                        if(employee instanceof StaffMember){
                            ...
                            staffMember.showStaffMemberInfo(staffMember);
                        }
                    }
                    break;
