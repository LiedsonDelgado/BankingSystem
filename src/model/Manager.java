...
public class Manager extends Employee{
    ...
    public static int nextManagerId = 1;
    ...
    public Manager(String p_name,String p_position,String p_phoneNumber,String p_specialization,ExperienceLevel p_experienceLevel,String p_balance,Bank p_bank,ArrayList<Client> p_lisOfClient,ArrayList<Account> p_listOfAccounts){
        super(p_name,null,p_phoneNumber,p_balance,p_experienceLevel,p_bank);
