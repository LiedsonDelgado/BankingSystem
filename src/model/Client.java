...
public class Client{ //extend de thread para futuras implementacoes
    ...
    public Client(String p_name,String p_email,String p_bornedYear,String p_clientAdress,String p_clientPhoneNumber,String p_idCard,int p_age,Account p_account){
        this.name = p_name;

        Email email = new Email(p_email);
        email.validateEmail(p_email);
        this.email = p_email;
