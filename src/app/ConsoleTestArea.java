...
public class ConsoleTestArea{
    public static void main(String[] args){
        ...
        Manager manager = new Manager("Marco Wahnon","mwahnon@gmail.com","Gerente de Administracao","+238 5819375","Gerencia",ExperienceLevel.SENIORLEVEL,"150000",bcv,bcv.getListOfClients(),bcv.getListOfAccounts());

        CreditCard c1 = new CreditCard(7642,"1234-2345-7483-3441",bcv,CardTypes.MASTERCARD);
        c1.setCardStatus(true);
        System.out.println(c1.showCardInfo(c1));

        CreditCard c2 = new CreditCard(8243,"1259-8815-9327-1006",bcv,CardTypes.VISA);
        c2.setCardStatus(true);
        System.out.println(c2.showCardInfo(c2));

        Account a1 = new Account("Liedson Delgado","xz89b7647",bcv,"200.00",true,c1);
        ...
        Account a2 = new Account("Nuno Silva","bz98c746v5",bcv,"150.00",true,c2);
