...
public class BankTest{
    ...
    CreditCard c1 = new CreditCard(1111,"1111-1111-1111-1111",bank,CardTypes.MASTERCARD);
    CreditCard c2 = new CreditCard(2222,"2222-2222-2222-2222",bank,CardTypes.AMERICANEXPRESS);
    CreditCard c3 = new CreditCard(3333,"3333-3333-3333-3333",bank,CardTypes.VISA);

    Account a1 = new Account("Account 1","111111111",bank,"1000",true,c1);
    Account a2 = new Account("Account 2","222222222",bank,"2000",true,c2);
    Account a3 = new Account("Account 3","333333333",bank,"3000",true,c3);
