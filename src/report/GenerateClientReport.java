...
public class GenerateClientReport{
    public void generateClientReport(Client p_client){ //recebe o conteudo das variaveis de instancia do objeto cliente
        try{
            ...
            String fileName = "client_report_";
            String filePath = "E:/Personal Projects/Java/BankingSystem/files/reports/client/";
            String fileExtension = ".json";

            String newFileName = (filePath+fileName+p_client.getClientId()+fileExtension);
