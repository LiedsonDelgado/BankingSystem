public class MainTestArea{
    public static void main(String[] args){
        ...
        CreditCard c1 = new CreditCard(7642,"1234-2345-7483-3441","BCV Services","Executivo");
        CreditCard c2 = new CreditCard(8243,"1259-8815-9327-1006","BCV Services","Comum-T1");
        ...
        String p_extension = ".xlsx";

        GenerateAccountReport generator = new GenerateAccountReport(); //objeto que cria o gerador de relatorios
        generator.generateAccountReport(p_filename,p_filepath,p_extension,p_account);
