public class MainTestArea{
    public static void main(String[] args){
        ...
        Report r1 = new Report(".pdf",p_account); //objeto que que representa os relatorios
        r1.setContent(p_account);

        GenerateReport generator = new GenerateReport(); //objeto que cria o gerador de relatorios
        generator.generate(p_account,"relatorio_cliente","E:/!UTA(Pratica)/POO/InteliJ_Projects/Banco/files/",r1);
