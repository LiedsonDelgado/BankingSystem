public class Main{
    public static void main(String[] args){
        ...
        Report r1 = new Report(".pdf",a1); //objeto que que representa os relatorios
        GenerateReport generator = new GenerateReport(); //objeto que cria o gerador de relatorios
        generator.generate("Relatorio Teste","C:\\Users\\lieds\\Documents\\POO\\Banco\\files",r1);
