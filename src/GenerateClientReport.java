...
public class GenerateClientReport{
    ...
    public void generateClientReport(Client p_client){//recebe o conteudo das variaveis de instancia do objeto cliente
        try{
            ...
            String p_filepath = "E:/!UTA(Pratica)/POO/InteliJ_Projects/BankingSystem/files/relatorios/clientes/";
            ...
            System.out.println("Erro: nao foi possivel criar relatorio do cliente!");
